...
public class PoliceHelpline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationAccess = findViewById(R.id.pfindLocation_id);
        sendLocation = findViewById(R.id.psendLocation_id);
        sendLocation2 = findViewById(R.id.psend_id);
        typeLocation = findViewById(R.id.ptypeLocation_id);
        ...
        sendLocation.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (!connected){
                    Toast toast = Toast.makeText(PoliceHelpline.this, "Please Connect To The Internet", Toast.LENGTH_LONG);
                    toast.show();
                    return;
                }
