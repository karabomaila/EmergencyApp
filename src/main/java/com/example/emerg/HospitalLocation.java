...
public class HospitalLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationAccess = findViewById(R.id.hpallowLoaction_id);
        sendLocation = findViewById(R.id.hpsendLocation_id);
        sendLocation2 = findViewById(R.id.hpsend_id);
        typeLocation = findViewById(R.id.hptypeLocation_id);
        ...
        sendLocation.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (!connected){
                    Toast toast = Toast.makeText(HospitalLocation.this, "Please! Connect To The Internet", Toast.LENGTH_LONG);
                    toast.show();
                    return;
                }
